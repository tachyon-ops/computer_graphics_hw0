...
void init (void) 
{
	...
	vertexshader = initshaders(GL_VERTEX_SHADER, "Data/shaders/light.vert.glsl") ;
	fragmentshader = initshaders(GL_FRAGMENT_SHADER, "Data/shaders/light.frag.glsl") ;
	...
	// Initialize texture
	inittexture("Data/assets/wood.ppm", shaderprogram) ; 
